		...
		<div>
			...
			<h1 className='text-center'>Create Book</h1>
				...
				{kategori_id.length > 0 ? (
					<select 
					className='form-select border-2' onChange={(e) => 
					setSelectedKategori(parseInt(e.target.value))}>
						<option 
						selected value="" 
						disabled hidden>
						</option>
				...
				{tahunError}
				<button type="submit" class="bg-biru text-white px-3 py-2 rounded-md">Send</button>
			</form>
		</div>
	);
};
