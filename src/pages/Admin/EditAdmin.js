        ...
        <form onSubmit={updateUser} className='flex justify-start flex-col rounded-md font-poppins'>
          <div className="card">
            ...
            <label className="font-bold text-2xl justify-start flex-col rounded-md font-poppins ">Nama</label>
              <input
                type="text"
                className="appearance-none border rounded w-full py-2 px-3 mb-4 text-gray-700 focus:outline-none focus:shadow-outline"
                value={nama}
          ...
          <div className="col-12">
            <label className="font-bold text-2xl justify-start flex-col rounded-md font-poppins">Role</label>
                <select
                  ...
                  className="border rounded w-half py-2 px-3 mb-4 text-gray-700 focus:outline-none focus:shadow-outline"
                >
