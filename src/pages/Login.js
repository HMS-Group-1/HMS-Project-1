		...
		<div className=" desktop:flex desktop:items-center desktop:h-screen desktop:justify-center pt-7">
			<div className="desktop:w-5/12 laptop: w-full mobile:w-full tablet:w-full ">
				...
				<figure className="tablet:mx-12 mobile:mx-12">
					<blockquote className="font-poppins font-semibold py-3 text-justify desktop:text-2xl tablet:text-xl tablet:my-2   tablet:w-full mobile:text-base">
			...
			<div className="bg-red-50 flex justify-start flex-col rounded-md font-poppins  mobile:mx-12 mobile:my-5 mobile:px-5 mobile:items-center mobile:pb-8  ">
				...
				<form className="flex flex-col w-full mobile:px-3">
					...
					<input class="appearance-none border rounded w-full py-2 px-3 mb-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="@email" />
					...
					<div class="items-center justify-between pt-4 tablet:flex tablet:flex-col mobile:flex mobile:flex-col">
						...
						<p class="inline-block align-baseline font-bold text-sm text-blue-500 tablet:pt-2 ">Belum punya akun? Daftar Sekarang!</p>
					</div>
				</form>
			</div>
		</div>
