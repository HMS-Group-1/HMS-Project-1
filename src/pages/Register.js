...
const Register = () => {
	...
	return (
		<div className=" desktop:flex desktop:items-center desktop:h-screen desktop:justify-center pt-7">
			<div className="desktop:w-4/12 laptop: w-ful mobile:w-full tablet:w-full ">
				<div>
				...
				<figure className="tablet:mx-12 mobile:mx-12">
					<blockquote className="font-poppins font-semibold  text-justify desktop:py-7 desktop:text-2xl desktop:leading-loose  tablet:text-2xl tablet:my-2 tablet:py-5 tablet:leading-loose tablet:w-full mobile: pt-3 mobile:text-base">
			...
			<div className="bg-red-50 flex justify-start flex-col rounded-md font-poppins  desktop:w-4/12 mobile:mx-12 mobile:my-5 mobile:px-5 mobile:items-center mobile:pb-8  ">
				...
				<h5 className="w-11/12 pt-0 pb-3 tablet:w-full tablet:pl-3 tablet:pt-1 tablet:text-base mobile:w-11/12 mobile:text-sm">Daftar akunmu dulu ya!</h5>
				<form onSubmit={register} className="flex flex-col w-full mobile:px-3">
					<p className="text-center text-merahTua font-bold text-lg">{message}</p>
					<div className="desktop:flex desktop:flex-row desktop:items-center desktop:-mb-2">
