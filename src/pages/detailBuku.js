            ...
            {loading ? (
                <div key={books.id}>
                    ...
                    <div class="flex justify-start desktop:flex-col font-poppins  mobile:mx-12 mobile:my-5 mobile:px-5 mobile:items-center mobile:pb-8  ">
                        <h1 className='font-bold text-3xl justify-start flex-col rounded-md font-poppins'><b>{books.judul_buku}</b></h1>
                        <br></br>
                        <h2 className='text-xl font-bold justify-start flex-col rounded-md font-poppins'><strong>No : {books.id}</strong></h2>
                        <br></br>
                        <h3 className='text-2xl font-bold justify-start flex-col rounded-md font-poppins'><strong>Category: {books.Kategori_id.kategori_nama}</strong></h3>
                        <br></br>
                        <h2 className='text-2xl font-bold justify-start flex-col rounded-md font-poppins'><strong>Sinopsis</strong></h2>
                        <hr></hr>
                        ...
                        <div class='pt-4 desktop:flex-row tablet:flex tablet:flex-col mobile:flex mobile:flex-col'>
                            <button className="bg-red-500 w-12/12 text-white w-full font-bold py-3 px-4 mx-1 rounded-md mb-3 focus:outline-none focus:shadow-outline" onClick={kembali}>kembali</button>
                            <button className="bg-blue-500 w-12/12 text-white w-full font-bold py-3 px-4 mx-1 rounded-md mb-3 focus:outline-none focus:shadow-outline" onClick={() => pinjamHandler(books.id)}>Pinjam</button>
                        </div>
                    </div>
                    <div class='col-1'></div>
                </div>) : "loading"}
